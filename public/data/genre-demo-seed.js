...
(function (global) {
  ...
  const DEMO_DISCUSSIONS = {
    fantasy: [
      ...
      },
      {
        ...
        body: `Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence. Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence.
         Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence.Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence.Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence.
         Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence.Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence.Prophecy, mirror scene, last line — they connect. Spoiler-safe Fantasy theory thread. Bring evidence.`,
  ...
  /* Thread replies for discussion.html. The '@OP' reply is personalized
     with the thread author's name/avatar at render time. */
  const DEMO_THREAD_COMMENTS = [
    {
      name: 'StarfallReader', avatar: 'https://i.pravatar.cc/100?img=12', verified: 'reader',
      time: '1h ago', text: 'This is exactly the take I needed. The middle act only works if the cost is personal.',
      likes: 24, liked: false,
      replies: [
        { name: '@OP', avatar: '', time: '50m ago', text: 'Appreciate this — that was the intent.', likes: 11, liked: false, replies: [] },
      ],
    },
    {
      name: 'MythicInk', avatar: 'https://i.pravatar.cc/100?img=33', verified: 'writer',
      time: '2h ago', text: 'Hard disagree on the finale point — track the side plots and it lands.',
      likes: 41, liked: false, replies: [],
    },
    {
      name: 'ElfQueen', avatar: 'https://i.pravatar.cc/100?img=45',
      time: '3h ago', text: 'Came from the hub Hot list. Staying for the comments.',
      likes: 9, liked: false, replies: [],
    },
    {
      name: 'BladeTheory', avatar: 'https://i.pravatar.cc/100?img=5',
      time: '4h ago', text: 'Spoiler-safe: the mentor line early on is the whole engine.',
      likes: 33, liked: false, replies: [
        { name: 'RuneReader', avatar: 'https://i.pravatar.cc/100?img=25', time: '3h ago', text: 'Yes — and the map point still stands.', likes: 7, liked: false, replies: [] },
        { name: 'MapNerd', avatar: 'https://i.pravatar.cc/100?img=53', time: '2h ago', text: 'Geography should matter more often in this genre.', likes: 14, liked: false, replies: [] },
        { name: 'QuestGiver', avatar: 'https://i.pravatar.cc/100?img=20', time: '1h ago', text: 'View-all test thread material right here.', likes: 3, liked: false, replies: [] },
      ],
    },
    {
      name: 'ShelfWitch', avatar: 'https://i.pravatar.cc/100?img=9',
      time: '5h ago', text: 'Anyone have a rec that does this trope without the slog?',
