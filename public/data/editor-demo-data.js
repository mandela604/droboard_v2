...
(function () {
  ...
  var BOOKS = [
    { id:'BK001256', title:'The Ruthless CEO', author:'Ava Winters', avatar:'https://i.pravatar.cc/100?img=45', cat:'Romance', genre:'Billionaire Romance', status:'Published', views:'1.2M', added:'Jun 15, 2026', img:'https://i.postimg.cc/RqtfSQJJ/wife3.jpg', desc:'Driven by power, torn by desire. A billionaire romance like no other.', chapters:42 },
    { id:'BK001255', title:'Bound by the Ruthless Alpha', author:'Luna Skye', avatar:'https://i.pravatar.cc/100?img=32', cat:'Romance', genre:'Werewolf Romance', status:'Published', views:'946K', added:'Jun 14, 2026', img:'https://i.postimg.cc/vDn9YLx5/wife2.jpg', desc:'She was meant to be his enemy, but fate had other plans.', chapters:31 },
    { id:'BK001254', title:'His Hidden Luna', author:'Lyra Night', avatar:'https://i.pravatar.cc/100?img=25', cat:'Romance', genre:'Werewolf Romance', status:'Published', views:'832K', added:'Jun 13, 2026', img:'https://i.postimg.cc/fkdXzjSj/wife.jpg', desc:'A secret identity that could destroy the pack or unite it.', chapters:28 },
    { id:'BK001253', title:'Reborn to Revenge', author:'Mia Carter', avatar:'https://i.pravatar.cc/100?img=48', cat:'Urban', genre:'Revenge', status:'Under Review', views:'623K', added:'Jun 12, 2026', img:'https://i.postimg.cc/ftRZbhKx/3.jpg', desc:'Given a second chance at life, she will make them pay for every tear.', chapters:18 },
    { id:'BK001252', title:'Claimed by the Mafia King', author:'Bella King', avatar:'https://i.pravatar.cc/100?img=29', cat:'Romance', genre:'Mafia Romance', status:'Draft', views:'\u2014', added:'Jun 11, 2026', img:'https://i.postimg.cc/cgLZJNmC/8.jpg', desc:'A dangerous pact in the shadows of the underworld.', chapters:5 },
    { id:'BK001251', title:'The Vampire\'s Obsession', author:'Ethan Vale', avatar:'https://i.pravatar.cc/100?img=13', cat:'Fantasy', genre:'Vampire Romance', status:'Published', views:'512K', added:'Jun 10, 2026', img:'https://i.postimg.cc/WF1j4Pnh/6.jpg', desc:'Immortal hunger meets unbreakable mortal devotion.', chapters:24 },
    { id:'BK001250', title:'Broken Vows', author:'Sophie Lane', avatar:'https://i.pravatar.cc/100?img=31', cat:'Romance', genre:'Second Chance', status:'Flagged', views:'\u2014', added:'Jun 10, 2026', img:'https://i.postimg.cc/0MyxNqfz/7.jpg', desc:'Can love survive the truths they swore never to reveal?', chapters:15 },
    { id:'BK001249', title:'The Prince\'s Secret Wife', author:'Isabella Rose', avatar:'https://i.pravatar.cc/100?img=44', cat:'Romance', genre:'Royal Romance', status:'Published', views:'391K', added:'Jun 9, 2026', img:'https://i.postimg.cc/N9jY0w4m/5.jpg', desc:'Behind palace gates lies a royal scandal waiting to explode.', chapters:35 },
    { id:'BK001248', title:'Runaway Bride in Socked Feet', author:'Ifeanyi_Story', avatar:'https://i.pravatar.cc/100?img=53', cat:'Romance', genre:'Twist', status:'Published', views:'312K', added:'Jun 8, 2026', img:'https://i.postimg.cc/RqtfSQJJ/wife3.jpg', desc:'Leaving the altar was only the beginning of her real journey.', chapters:22 },
    { id:'BK001247', title:'The Letter He Never Sent', author:'Efe_O', avatar:'https://i.pravatar.cc/100?img=22', cat:'Elegy', genre:'Romance', status:'Published', views:'218K', added:'Jun 7, 2026', img:'https://i.postimg.cc/23WvkFLH/images-(2).jpg', desc:'Words hidden in an old drawer change two lives forever.', chapters:15 },
    { id:'BK001246', title:'Caught Kissing Her Photograph', author:'Ada_Writes', avatar:'https://i.pravatar.cc/100?img=32', cat:'Romance', genre:'Betrayal', status:'Published', views:'171K', added:'Jun 6, 2026', img:'https://i.postimg.cc/vDn9YLx5/wife2.jpg', desc:'A picture is worth a thousand lies.', chapters:19 },
    { id:'BK001245', title:'She Rejected Me 3 Times', author:'Dami_Cole', avatar:'https://i.pravatar.cc/100?img=64', cat:'Romance', genre:'Second Chance', status:'Published', views:'22K', added:'Jun 5, 2026', img:'https://i.postimg.cc/fkdXzjSj/wife.jpg', desc:'Three rejections, one last desperate gamble for her heart.', chapters:8 },
    { id:'BK001244', title:'The Richest Boy Beside Me', author:'CampusQueen', avatar:'https://i.pravatar.cc/100?img=12', cat:'Campus', genre:'Romance', status:'Published', views:'134K', added:'Jun 4, 2026', img:'https://i.postimg.cc/cgLZJNmC/8.jpg', desc:'She thought he was a broke student until she saw his motorcade.', chapters:16 },
    { id:'BK001243', title:'Stepmother Stole My Fund', author:'Zara_M', avatar:'https://i.pravatar.cc/100?img=16', cat:'Revenge', genre:'Family Drama', status:'Published', views:'192K', added:'Jun 3, 2026', img:'https://i.postimg.cc/ftRZbhKx/3.jpg', desc:'Reclaiming her inheritance, one calculated step at a time.', chapters:20 },
  ];
